...
class TestPopulateRegistryComponentsToolDedup:
    ...
    def test_config_distinct_toolkits_resolve_to_first_deterministically(self):
        ...
        first = WebSearchTools(fixed_max_results=3)
        second = WebSearchTools(fixed_max_results=99)
        ...
        assert os.registry._entrypoint_lookup["search_web"].entrypoint.__self__ is first
